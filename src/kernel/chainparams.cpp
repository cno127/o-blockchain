...
public:
    CMainParams() {
        ...
        // Clear assumeutxo data for custom network
        m_assumeutxo_data = {};
...
public:
    CTestNetParams() {
        ...
        consensus.hashGenesisBlock = genesis.GetHash();
        // O Blockchain: Commented out Bitcoin genesis assertions for testing
        // TODO: Generate proper O Blockchain genesis block
